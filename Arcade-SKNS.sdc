...
#set_false_path -to {emu:emu|Saturn:saturn|VDP1:VDP1|GRD_CALC_STEP.R.*[*] emu:emu|Saturn:saturn|VDP1:VDP1|GRD_CALC_STEP.G.*[*] emu:emu|Saturn:saturn|VDP1:VDP1|GRD_CALC_STEP.B.*[*]}