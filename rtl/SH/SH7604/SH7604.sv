...
//						  (CBUS_A >= 32'hFFFFFE00);
	...
	wire USED_ADDR = (CBUS_A >= 32'h00000000 && CBUS_A < 32'h0007FFFF) || (CBUS_A >= 32'h20000000 && CBUS_A < 32'h2007FFFF) ||
	                 (CBUS_A >= 32'h00400000 && CBUS_A < 32'h0040000F) || (CBUS_A >= 32'h20400000 && CBUS_A < 32'h2040000F) ||
						  (CBUS_A >= 32'h00800000 && CBUS_A < 32'h00801FFF) || (CBUS_A >= 32'h20800000 && CBUS_A < 32'h20801FFF) || 
						  (CBUS_A >= 32'h00C00000 && CBUS_A < 32'h00C00001) || (CBUS_A >= 32'h20C00000 && CBUS_A < 32'h20C00001) || 
	                 (CBUS_A >= 32'h01000000 && CBUS_A < 32'h0100000F) || (CBUS_A >= 32'h21000000 && CBUS_A < 32'h2100000F) ||
	                 (CBUS_A >= 32'h01800000 && CBUS_A < 32'h01800003) || (CBUS_A >= 32'h21800000 && CBUS_A < 32'h21800003) ||
						  (CBUS_A >= 32'h02000000 && CBUS_A < 32'h02FFFFFF) || (CBUS_A >= 32'h22000000 && CBUS_A < 32'h22FFFFFF) || 
						  (CBUS_A >= 32'h04000000 && CBUS_A < 32'h04FFFFFF) || (CBUS_A >= 32'h24000000 && CBUS_A < 32'h24FFFFFF) || 
	                 (CBUS_A >= 32'h05000000 && CBUS_A < 32'h05000003) || (CBUS_A >= 32'h25000000 && CBUS_A < 32'h25000003) ||
	                 (CBUS_A >= 32'h06000000 && CBUS_A < 32'h060FFFFF) || (CBUS_A >= 32'h26000000 && CBUS_A < 32'h260FFFFF) ||
						  (CBUS_A >= 32'h40000000 && CBUS_A < 32'h48000000) || 
						  (CBUS_A >= 32'h60000000 && CBUS_A < 32'h80000000) || 
						  (CBUS_A >= 32'hC0000000 && CBUS_A < 32'hC0001000) || 
						  (CBUS_A >= 32'hFFFF8000 && CBUS_A < 32'hFFFFC000) || 
	...
	always @(posedge CLK or negedge RST_N) begin
//		bit MKR_HOOK1,MKR_HOOK2,DBG_MKR_ARG2_UPD;
//		bit [15:0] DBG_MKR_DIFF;
		
		if (!RST_N) begin
			UNUSED_REQ <= '0;
			HOOK <= 0;
			HOOK2 <= 0;
//			{MKR_HOOK1,MKR_HOOK2} <= '0;
//			{DBG_ATL_0604A570,DBG_ATL_0604B74C,DBG_ATL_060437AE} <= 0;
		end
		else begin	
//			HOOK <= 0;
//			if (CBUS_A == 32'h060B7274 && CBUS_DI == 32'h4F226903 && CBUS_REQ && !CBUS_WR && !CACHE_BUSY && CE_R) HOOK <= 1;
//			if (CBUS_A == 32'h0609FDF8 && CBUS_DI == 32'h6002201B && CBUS_REQ && !CBUS_WR && !CACHE_BUSY && CE_R) HOOK <= 0;
